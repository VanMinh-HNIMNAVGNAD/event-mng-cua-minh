...
public class EventService {
        ...
        public Page<EventResponse> getAllPublished(
                ...
                org.springframework.data.jpa.domain.Specification<Event> spec = (root, query, cb) -> {
                        ...
                        // Chỉ lấy các sự kiện có trạng thái hoạt động
                        ...
                        // Lọc theo giá vé (Join với TicketType)
                        if (minPrice != null || maxPrice != null) {
                                jakarta.persistence.criteria.Join<Event, TicketType> ticketJoin = root.join("ticketTypes");
                                if (minPrice != null) {
