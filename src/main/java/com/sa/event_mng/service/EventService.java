...
public class EventService {
        ...
        public Page<EventResponse> getAllPublished(
            ...
            PageRequest pageRequest) {
                ...
                org.springframework.data.jpa.domain.Specification<Event> spec = 
                    com.sa.event_mng.repository.specification.EventSpecification.filterEvents(
        ...
        public List<com.sa.event_mng.dto.response.BlogEventResponse> getBlogNews() {
                List<EventStatus> activeStatuses = List.of(EventStatus.UPCOMING, EventStatus.OPENING);
                LocalDateTime now = LocalDateTime.now();
                
                // Lấy các sự kiện đang hoạt động và chưa kết thúc
                ...
                return events.stream().map(e -> com.sa.event_mng.dto.response.BlogEventResponse.builder()
                        .id(e.getId())
                        .name(e.getName())
